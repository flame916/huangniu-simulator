(function (global) {
  const GameData = {
    ...
    TASKS: {
      'T0-1': { id: 'T0-1', chapter: 'prologue', name: '抢到悬崖火锅号', goal: '0.3% 挑战中签', minigame: '秒杀时刻(教学)', baseRate: 0.003, mode: 'timing', progressTarget: 1, rewards: { luck: 100 }, nextTask: 'T1-1' },
      'T1-1': { id: 'T1-1', chapter: 'ch1', name: '抢普通桌', goal: '中签 1 次', minigame: '秒杀时刻', baseRate: 0.05, mode: 'timing', progressTarget: 1, rewards: { level: 1 }, nextTask: 'T1-2' },
      'T1-2': { id: 'T1-2', chapter: 'ch1', name: '抢 VIP 悬崖包间', goal: '中签 1 次', minigame: '秒杀时刻+验证码', baseRate: 0.31, mode: 'timing', progressTarget: 1, rewards: { level: 3, unlock: 'flag:metXiaoyu' }, nextTask: 'T2-1' },
      'T2-1': { id: 'T2-1', chapter: 'ch2', name: '抢泡泡玛特限定款', goal: '中签 1 次', minigame: '夜排卡位', baseRate: 0.50, mode: 'timing', progressTarget: 1, rewards: { luck: 2000 }, nextTask: 'T2-2' },
      'T2-2': { id: 'T2-2', chapter: 'ch2', name: '连抢 7 家门店', goal: '扫货 7/7', minigame: '夜排卡位×7', baseRate: 0.99, mode: 'rapid', progressTarget: 7, rapidTaps: 7, rewards: { luck: 8000, money: 20000, unlock: 'flag:xianyu' }, nextTask: 'T2-3' },
      ...
      'T3-1': { id: 'T3-1', chapter: 'ch3', name: '抢周炸炸演唱会票', goal: '100 张 VIP 连座', minigame: '多线作战', baseRate: 0.95, mode: 'rapid', progressTarget: 10, rapidTaps: 10, rewards: { level: 5, broadcast: true, money: 50000 }, nextTask: 'T3-2' },
      'T3-2': { id: 'T3-2', chapter: 'ch3', name: '躲过曝光风暴', goal: '风控值低于 60 全身而退', minigame: '风控结算', baseRate: 0, mode: 'riskcheck', progressTarget: 1, rewards: { unlock: 'flag:survivedStorm' }, nextTask: 'T4-1' },
      'T4-1': { id: 'T4-1', chapter: 'ch4', name: '抢全球终极盛典门票', goal: '唯一门票', minigame: '万物之巅(全机制)', baseRate: 1.0, mode: 'timing', progressTarget: 1, rewards: { broadcast: true }, nextTask: 'T4-2' },
